...
import { type ActionOptions } from "@/lib/api/rich-menu-form-data";
...
export type FolderOption = Pick<RichMenuFolder, "id" | "name" | "is_system">;

export const EMPTY_ACTION_OPTIONS: ActionOptions = {
    tags: [],
    chatStatuses: [],
    friendFieldFolders: [],
    scenarios: [],
